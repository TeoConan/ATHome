...
require_once($_SERVER['DOCUMENT_ROOT'] . "/projet/athome/product/models/styleModel.php");
require_once($_SERVER['DOCUMENT_ROOT'] . "/projet/athome/product/models/typeModel.php");
require_once($_SERVER['DOCUMENT_ROOT'] . "/projet/athome/product/models/pieceModel.php");
...
require_once($_SERVER['DOCUMENT_ROOT'] . "/projet/athome/product/objects/style.php");
require_once($_SERVER['DOCUMENT_ROOT'] . "/projet/athome/product/objects/type.php");
require_once($_SERVER['DOCUMENT_ROOT'] . "/projet/athome/product/objects/piece.php");
